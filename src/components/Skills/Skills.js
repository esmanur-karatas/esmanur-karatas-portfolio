            ...
            <div className="skills-wrapper">
                <div className="skills-row">
                    ...
                    <div className="skill-group">
                        ...
                        <div className="skill-icon"><i className="devicon-html5-plain colored"></i> HTML5</div>
                        <div className="skill-icon"><i className="devicon-css3-plain colored"></i> CSS3</div>
                    ...
                    <div className="skill-group">
                        ...
                        <div className="skill-icon"><i className="devicon-github-plain colored"></i> GitHub</div>
                        <div className="skill-icon"><i className="devicon-jenkins-plain colored"></i> Jenkins</div>
                        <div className="skill-icon"><i className="devicon-github-plain colored"></i> GitHub Actions</div>
                    </div>
                </div>
                ...
                <div className="skills-row">
                    ...
                    <div className="skill-group">
                        ...
                        <div className="skill-icon"><i className="devicon-sourcetree-original colored"></i>OOP</div>
                        <div className="skill-icon"><i className="devicon-sourcetree-original colored"></i>BDD</div>
                    ...
                    <div className="skill-group">
                        <h4>Other Tools</h4>
                        <div className="skill-icon"><i className="devicon-mysql-plain colored"></i> SQL</div>
                        <div className="skill-icon"><i className="devicon-firebase-plain colored"></i> Firebase</div>
